...
{
    public static class AthenaRegistationContextExtensions
    {
        /// <summary>
        /// Registers a type to its self
        /// </summary>
        public static AthenaRegistration<TInterface, TInterface> ToItsSelf<TInterface>(this AthenaRegistationContext<TInterface> rc) where TInterface : class
        {
        ...
        public static AthenaRegistationContext<TInterface> Named<TInterface>(this AthenaRegistationContext<TInterface> rc, string name)
        {
    ...
    public static class AthenaRegistrationExtensions
    {
        /// <summary>
        /// Specifies this Registration as a Singleton
        /// </summary>
        public static void AsSingleton<TInterface, TImplementation>(this AthenaRegistration<TInterface, TImplementation> jr) where TImplementation : class, TInterface
        {
        ...
        public static void AsSingleton<TInterface, TImplementation>(this AthenaRegistration<TInterface, TImplementation> jr, TImplementation obj) where TImplementation : class, TInterface
        {
        ...
        /// </summary>
        /// <param name="obj">Singleton object</param>
        public static void AsValueSingleton<TInterface, TImplementation>(this AthenaRegistration<TInterface, TImplementation> jr, TImplementation obj) where TImplementation : struct, TInterface
        {
        ...
        /// </summary>
        public static void AsTransient<TInterface, TImplementation>(this AthenaRegistration<TInterface, TImplementation> jr) where TImplementation : TInterface
        {
